...
The datasets could be downloaded here: [Turkey Electrical Appliances Dataset (TEAD)](https://github.com/vahit19/smart_grid/blob/main/data.rar) and Benchmark [Residential Energy Disaggregation Dataset (REDD)](http://redd.csail.mit.edu/) and [UK-DALE](https://jack-kelly.com/data/)
